...
main = tkinter.Tk()
main.title("Detection of cyber security in network using machine learning techniques")
...
font = ('times', 16, 'bold')
title = Label(main, text='Detection of cyber security in network using machine learning techniques')
